...
public class EUMMetricQuery {
    ...
    /* EUM Ajax */
    public static String queryEUM_AJAX_All(String baseURL, String application, String urlPath, long start, long end, boolean rollup){
        ...
        bud.append(urlPath).append(s._ALL_);
...
DOM Ready Time 99th percentile (ms)
    ...
    /* EUM Base Pages */
    public static String queryEUM_BASE_PAGES_All(String baseURL, String application, String urlPath, long start, long end, boolean rollup){
        StringBuilder val=new StringBuilder();
        val.append(baseURL).append(s.CONTROLLER_APPS);
        val.append(QueryEncoder.encode(application));
        val.append(s.URL_METRIC_PATH);
...
-- Done DOM Ready Time (ms)
    ...
    public static String queryEUM_IFRAME_All(String baseURL, String application, String urlPath, long start, long end, boolean rollup){
        StringBuilder val=new StringBuilder();
        val.append(baseURL).append(s.CONTROLLER_APPS);
        val.append(QueryEncoder.encode(application));
        val.append(s.URL_METRIC_PATH);
